...
% --TO BE FILLED IN--
\noindent
\textbf{Student name:} Yari Vanherpe\dotfill \hfill \textbf{Student number:} r0836149\dotfill
...
\begin{tabularx}{\linewidth}{@{}lXlX@{}}
\textbf{Title Bachelor’s or Master’s thesis:} & Reasoning about smePMP\dotfill & \textbf{Supervisor:} & Dominique Devriese\dotfill \\
\end{tabularx}

\vspace{1em}

\textbf{Daily supervisor:} Sander Hutghebaert\dotfill
...
X I \textbf{did use} GenAI Assistance. In this case \textbf{specify which ones} (e.g.\ ChatGPT, M365 Copilot, …): Claude Haiku 4.5, github copilot, ChatGPT\dotfill
...
\textbf{As a language assistant for reviewing or improving texts I wrote myself} & Claude Haiku 4.5, ChatGPT & This use is similar to using spelling and grammar check tools. In general, you do not have to refer to such kind of GenAI use in the text. 
