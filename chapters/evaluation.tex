...
Finally, the chapter discusses the experience of extending the Katamaran framework, including observations on its usability and the challenges encountered during development. \sand{You didn't extend Katamaran, only a case study. Think of it like this: Katamaran is the language, you extended a program written in that language}
...
\sand{You could opt to mention other shortcomings you experienced: lack of manual/resource for learning Katamaran, maybe you found the error messages you encountered during your thesis to be too vague/unhelpful, ...}
